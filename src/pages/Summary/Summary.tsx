...
export const Summary = ({onChange}: SummaryProps) => {
  ...
  return (
        <div
            className={`${!isCollapsed ? 'h-[258px]' : 'h-[523px]'} w-[439px] bg-white pt-[8px] pb-[16px] pl-[16px] pr-[8px] rounded-[12px] border border-white-active`}>
          <div className={`${!isCollapsed ? 'h-[225px]' : 'h-[485px]'} scroll-bar overflow-y-scroll`}>
            ...
            <h3 className='pb-[10px] text-dark-blue font-open-sans text-[16px] font-bold'>Стратегия выхода на рынок</h3>
              <div onClick={getSummaryHandle} className='cursor-pointer w-[40px] h-[40px] bg-[#514DF7] rounded-[13px] content-evenly pl-[8px]'>
            <Download />
              </div>
            </div>
